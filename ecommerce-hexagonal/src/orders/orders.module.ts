...
import {
  ORDER_REPOSITORY,
} from './application/ports/outbound/order-repository.port.js';
import {
  ORDER_PRODUCT_REPOSITORY,
} from './application/ports/outbound/product-repository.port.js';
import {
  PAYMENT_GATEWAY,
...
@Module({
  ...
  providers: [
    ...
    { provide: ORDER_PRODUCT_REPOSITORY, useClass: TypeOrmOrderProductRepository },

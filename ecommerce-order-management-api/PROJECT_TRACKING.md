...
| #    | Task                                                                                                                                           | Done | Notes                                                                                                                                               |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| 7.1  | **Event Listeners** — Wire up `@OnEvent()` listeners for `order.created` and `payment.processed` (e.g., send email, update inventory)          |      | Events emitted but no consumers — easiest win                                                                                                       |
...
| 7.6  | **Dynamic Modules** — Build a custom configurable module (e.g., `forRootAsync()` pattern)                                                      |      |                                                                                                                                                     |
...
| 7.9  | **Background Jobs** — Queue-based email sending with BullMQ, retry strategies, dead-letter queues                                              |      |                                                                                                                                                     |
